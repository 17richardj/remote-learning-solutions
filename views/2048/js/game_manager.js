          ...
          geocoder.geocode({'latLng': latlng}, function(results, status) {
            ...
            //console.log(results);
              ...
              for (var i=0; i<results[indice].address_components.length; i++)
                  ...
                  var person = confirm("<h5><strong>Score Details</strong></h5>\n" + "<br><strong>Your Score: </strong>" + this.score + "\n<br><strong>Your Location is: </strong>" + city + "\nGreat Job!");

                  if (!person) {
                    console.log("Data not submitted.")
                  } else {
                    //var userScore = document.getElementById("scor");
                    //userScore.value = this.score;
                    var data = {};
